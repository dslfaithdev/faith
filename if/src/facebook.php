...
class Facebook
{
  ...
  protected $is_FAITH_REST = false; 	//*FAITH*
  ...
  public function Set_Is_FAITH_REST($is_faith)	//*FAITH*
  {
  	$this->is_FAITH_REST  = $is_faith;
  	return $this->is_FAITH_REST;
  }	//*FAITH*
