...
<tr>
	...
	{
		$facebook->request('http://apps.facebook.com/dsl_faith_iframe/',
...
<tr>
	...
	{	
		...
		if(isset($_GET['ffile']) && isset($_GET['fpro']))
		{
		    ...
		    $post_params[] = 'faith_i='.urlencode('120596987958636');
		    $post_params[] = 'faith_s='.urlencode('18b0533d96d25ad4e23ca8386039b6c4');
		...
		$FaithFBURL = 'http://apps.facebook.com/dsl_faith_iframe/';
