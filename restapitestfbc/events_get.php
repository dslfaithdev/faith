...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/events_get.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->events_get();
		echo "<br>facebook->api_client->events_get() REST API CALLED <br>";
