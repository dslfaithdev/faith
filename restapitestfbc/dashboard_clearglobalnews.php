...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/dashboard_clearglobalnews.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->dashboard_clearGlobalNews();
		echo "<br>facebook->api_client->dashboard_clearGlobalNews() REST API CALLED <br>";
