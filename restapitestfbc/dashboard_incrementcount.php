...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/dashboard_incrementcount.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->dashboard_incrementCount();
		echo "<br>facebook->api_client->dashboard_incrementCount() REST API CALLED <br>";
