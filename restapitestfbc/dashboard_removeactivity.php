...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/dashboard_removeactivity.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$activity_ids = array('113289925355531');
		$result = $facebook->api_client->dashboard_removeActivity($activity_ids);
		echo "activity_ids = array('113289925355531')";
		echo "<br>facebook->api_client->dashboard_removeActivity($activity_ids) REST API CALLED <br>";
