...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/notifications_get.php/', false, $context);
	echo $homepage;
	...
	try
	{
		...
		echo "<br>facebook->api_client->notifications_get() REST API CALLED <br>";
