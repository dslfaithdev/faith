...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/application_getpublicinfo.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->application_getPublicInfo('313328481844');
		echo "<br>facebook->api_client->application_getPublicInfo('313328481844') REST API CALLED <br>";
