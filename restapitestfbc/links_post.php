...
try
{
	...
	try
	{
		$result = $facebook->api_client->links_post('http://www.google.com/','test faith facebook connect');
		echo "<br>facebook->api_client->links_post('http://www.google.com/','test faith facebook connect') REST API CALLED <br>";
