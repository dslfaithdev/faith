...
try
{
	...
	try
	{
		...
		$news = array(array('message' => '(Testing) dashboard_multiAddNews DSL FAITH FB Connect!',
		...
		echo "<br>news = array(array('message' => '(Testing) dashboard_multiAddNews DSL FAITH FB Connect!',
                    		'action_link' => array('text' => 'more details.',
