...
try
{
	...
	try
	{
		$result = $facebook->api_client->stream_getComments('1217497564_116320305048925');
		echo "<br>facebook->api_client->stream_getComments('1217497564_116320305048925') REST API CALLED <br>";
