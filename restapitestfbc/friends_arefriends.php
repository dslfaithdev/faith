...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/friends_arefriends.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->friends_areFriends('3200156,3210373', '3210373, 3200156');
		echo "<br>facebook->api_client->friends_areFriends('3200156,3210373', '3210373, 3200156') REST API CALLED <br>";
