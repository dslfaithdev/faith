...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/notes_delete.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->notes_delete('116085451735859');
		echo "<br>facebook->api_client->notes_delete('116085451735859') REST API CALLED <br>";
