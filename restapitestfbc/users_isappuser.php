...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/users_isappuser.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->users_isAppUser();
		echo "<br>facebook->api_client->users_isAppUser() REST API CALLED <br>";
