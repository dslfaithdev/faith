...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/photos_getalbums.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->photos_getAlbums();
		echo "<br>facebook->api_client->photos_getAlbums() REST API CALLED <br>";
