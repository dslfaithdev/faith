...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/dashboard_setcount.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->dashboard_setCount('3');
		echo "<br>facebook->api_client->dashboard_setCount('3') REST API CALLED <br>";
