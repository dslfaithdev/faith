...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/links_get.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->links_get();
		echo "<br>facebook->api_client->links_get() REST API CALLED <br>";
