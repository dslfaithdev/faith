...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/dashboard_getcount.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->dashboard_getCount();
		echo "<br>facebook->api_client->dashboard_getCount() REST API CALLED <br>";
