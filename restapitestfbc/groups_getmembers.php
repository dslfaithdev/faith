...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/groups_getmembers.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->groups_getMembers('28326909508');
		echo "<br>facebook->api_client->application_getPublicInfo('28326909508') (Davis Social Links) REST API CALLED <br>";
