...
try
{
	...
	try
	{
		$news = array(array('message' => '(Testing message) More function added to DSL FAITH Facebook Connect!',
		...
		echo "<br>news = array(array('message' => '(Testing message) More function added to DSL FAITH Facebook Connect!',
                    		'action_link' => array('text' => 'Check it out now.',
