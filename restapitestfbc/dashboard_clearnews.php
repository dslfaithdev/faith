...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/dashboard_clearnews.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$news_ids = array('112634535423177');
		$result = $facebook->api_client->dashboard_clearNews($news_ids);
		echo "news_ids = array('112634535423177');";
		echo "<br>facebook->api_client->dashboard_clearNews(news_ids) REST API CALLED <br>";
