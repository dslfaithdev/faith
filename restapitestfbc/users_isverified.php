...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/users_isverified.php/', false, $context);
	echo $homepage;
	...
	try
	{
		...
		echo "<br>facebook->api_client->users_isVerified() REST API CALLED <br>";
