...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/stream_get.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->stream_get('','','','','','app_YOURAPPLICATIONID','');
		echo "<br>facebook->api_client->stream_get('','','','','','app_YOURAPPLICATIONID','') REST API CALLED <br>";
