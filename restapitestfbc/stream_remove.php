...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/stream_remove.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->stream_remove('1217497564_116320305048925');
		echo "<br>facebook->api_client->stream_remove('1217497564_116320305048925') REST API CALLED <br>";
