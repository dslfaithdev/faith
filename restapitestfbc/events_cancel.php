...
try
{
	...
	try
	{
		$result = $facebook->api_client->events_cancel('107768205926754','Test events_cancel from DSL FAITH FB Connect');
		echo "<br>facebook->api_client->events_cancel('107768205926754','Test events_cancel from DSL FAITH FB Connect') REST API CALLED <br>";
