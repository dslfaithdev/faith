...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/pages_isfan.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->pages_isFan('103687943181');
		echo "<br>facebook->api_client->pages_isFan('103687943181') REST API CALLED <br>";
