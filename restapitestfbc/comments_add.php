...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/comments_add.php/', false, $context);
	echo $homepage;
	...
	try
	{
		//$result = $facebook->api_client->comments_add('app1', 'test comment added by FAITH (Facebook Connect)!');
		echo "<br>facebook->api_client->comments_add('app1', 'test comment added by FAITH (Facebook Connect)!') REST API CALLED <br>";
		
		echo "Comment ID: $result;<br>";
	}
	catch (Exception $e)
	{
