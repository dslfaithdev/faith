...
?>
	<tr>
		...
		<tr>
			<td>
			<form style="white-space:nowrap;" action="service_privacy_shield.php?setting=<?php echo $_GET['setting'] ?>" method="post">
			<table width="100%">
			<tr>
				<td width="60%">
				<?php
				...
				<input type="radio" name="app_select_input" id="app_select_input1" onclick="document.setLocation('<?php echo $facebook_canvas_page_url; ?>service_privacy_shield.php?setting=1');"
				<?php if($_GET['setting'] == '1') echo "CHECKED" ?>>Relationship Quality/Tie Strength</input><br />
				<input type="radio" name="app_select_input" id="app_select_input2" onclick="document.setLocation('<?php echo $facebook_canvas_page_url; ?>service_privacy_shield.php?setting=2');"
				<?php if($_GET['setting'] == '2') echo "CHECKED" ?>>Relationship Category/Friend List</input><br />
				<input type="radio" name="app_select_input" id="app_select_input3" onclick="document.setLocation('<?php echo $facebook_canvas_page_url; ?>service_privacy_shield.php?setting=3');"
