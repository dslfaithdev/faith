...
class Facebook
{
  ...
  protected $is_FAITH_GRAPH = false; 	//*FAITH*
  ...
  public function Set_Access_Token_For_FAITH($access_token)	//*FAITH*
  {
  	$this->session['access_token'] = $access_token;
  }	//*FAITH*
  
  public function Set_Is_FAITH_GRAPH($is_faith)	//*FAITH*
  {
  	$this->is_FAITH_GRAPH  = $is_faith;
  	return $this->is_FAITH_GRAPH;
  }	//*FAITH*
  ...
  public function request($redirect_url, $permissions)
  {
  	echo '<script type="text/javascript">top.location.href = "https://graph.facebook.com/oauth/authorize?client_id='.$this->appId.
	'&redirect_uri='.$redirect_url.'&scope='.$permissions.'";</script>';
  }
