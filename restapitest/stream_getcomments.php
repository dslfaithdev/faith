...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/stream_getcomments.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->stream_getComments('1217497564_106915176015292');
		echo "<br>facebook->api_client->stream_getComments('1217497564_106915176015292') REST API CALLED <br>";
