...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/friends_getappusers.php/', false, $context);
	echo $homepage;
	...
	try
	{
		...
		echo "<br>facebook->api_client->friends_getAppUsers() REST API CALLED <br>";
