...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/dashboard_multisetcount.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$ids = array('1217497564' => '3');
		$result = $facebook->api_client->dashboard_multiSetCount($ids);
		echo "ids = array('1217497564' => '3')";
		echo "<br>facebook->api_client->dashboard_multiSetCount(ids) REST API CALLED <br>";
