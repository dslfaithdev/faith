...
try
{
	...
	try
	{
		$news = array(array('message' => '(Testing message) dashboard_addNews from DSL FAITH!',
		...
		echo "<br>news = array(array('message' => '(Testing message) dashboard_addNews from DSL FAITH!',
                    		'action_link' => array('text' => 'Check it out now.',
