...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/data_getcookies.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->data_getCookies('1217497564');
		echo "<br>facebook->api_client->data_getCookies('1217497564') REST API CALLED <br>";
