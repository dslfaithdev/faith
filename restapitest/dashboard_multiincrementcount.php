...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/dashboard_multiincrementcount.php/', false, $context);
	echo $homepage;
	...
	try
	{
		...
		$result = $facebook->api_client->dashboard_multiIncrementCount($ids);
		echo "ids = array('1217497564')";
		echo "<br>facebook->api_client->dashboard_multiIncrementCount(ids) REST API CALLED <br>";
