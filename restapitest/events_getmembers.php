...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/events_getmembers.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->events_getMembers('116742655008055');
		echo "<br>facebook->api_client->events_getMembers('116742655008055') REST API CALLED <br>";
