...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/stream_getfilters.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->stream_getFilters();
		echo "<br>facebook->api_client->stream_getFilters() REST API CALLED <br>";
