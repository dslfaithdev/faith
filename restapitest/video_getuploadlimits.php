...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/video_getuploadlimits.php/', false, $context);
	echo $homepage;
	...
	try
	{
		...
		echo "<br>facebook->api_client->video_getUploadLimits() REST API CALLED <br>";
