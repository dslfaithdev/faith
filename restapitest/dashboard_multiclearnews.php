...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/dashboard_multiclearnews.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$ids = array('1217497564' => array());
		$result = $facebook->api_client->dashboard_multiClearNews($ids);
		echo "ids = array('1217497564' => array());";
		echo "<br>facebook->api_client->dashboard_multiClearNews(ids) REST API CALLED <br>";
