...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/admin_getmetrics.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->admin_getMetrics(1213858800,
                                            			  1213945200,
                                            			  604800,
                                            			  array('active_users',
                                            			  		'api_calls',
		...
		echo "<br>facebook->api_client->admin_getMetrics(1213858800,
                                            			  1213945200,
                                            			  604800,
                                            			  array('active_users',
                                            			  		'api_calls',
                                            			  		...
                                            			  		'unique_canvas_page_views',
                                            			  		'canvas_http_request_time_avg',
                                            			  		'canvas_fbml_render_time_avg')) REST API CALLED <br>";
