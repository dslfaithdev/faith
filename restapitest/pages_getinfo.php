...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/pages_getinfo.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->pages_getInfo('', 'page_id , name , fan_count ');
		echo "<br>facebook->api_client->pages_getInfo('', 'page_id , name , fan_count ') REST API CALLED <br>";
