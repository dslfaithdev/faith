...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/dashboard_multigetnews.php/', false, $context);
	echo $homepage;
	...
	try
	{
		...
		$result = $facebook->api_client->dashboard_multiGetNews($ids);
		echo "ids = array('1217497564' => array())";
		echo "<br>facebook->api_client->dashboard_multiGetNews(ids) REST API CALLED <br>";
