...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/photos_get.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->photos_get('', '5229112220341729155', '');
		echo "<br>facebook->api_client->photos_get('', '5229112220341729155', '') REST API CALLED <br>";
