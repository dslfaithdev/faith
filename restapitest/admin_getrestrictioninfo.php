...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/admin_getrestrictioninfo.php/', false, $context);
	echo $homepage;
	...
	try
	{
		...
		echo "<br>facebook->api_client->admin_getRestrictionInfo() REST API CALLED <br>";
