...
try
{
	...
	$homepage = file_get_contents('http://169.237.6.102/~dslfaith/testapplicationone/restapitest/comments_get.php/', false, $context);
	echo $homepage;
	...
	try
	{
		$result = $facebook->api_client->comments_get('app1');
		echo "<br>facebook->api_client->comments_get('app1') REST API CALLED <br>";
