...
<tr>
	...
	<tr>
		...
		<br />
		<h4>View Access History by Application :</h4>
		last 100 accesses made by the selected applications to your profile.
		</td>
		<td width="50px"></td></tr>
		</table>
		</td>
...
function do_ajax(div,val,uid) {
	...
	var params={"action":'select',"option":val,"searchwords":document.getElementById('txttt').getValue(),"otherval":uid};
